...
common.LogOutput('info', "\nAdding interface to vrf_default")
devIntRetStruct = switch.DeviceInteract(connection=dut01_conn, command="vrf attach vrf_default")
retCode = devIntRetStruct.get('returnCode')
if retCode != 0:
   common.LogOutput('error', "\nFailed to add interface to vrf_default ")
